...
void UMerchantComponent::RemoveItemID_Implementation(int64 ItemID)
{
...
int64 UMerchantComponent::GetItemAtIndex(int32 ListIndex) const
{
...
int64 UMerchantComponent::GetItemFromStaticPool(int32 ListIndex) const
{
	if (ListIndex < StaticMerchantPool.Num())
		return StaticMerchantPool[ListIndex];
...
bool UMerchantComponent::HasItem(int64 ItemID) const
{
...
void UMerchantComponent::InitStatic_Implementation(const TArray<int64>& MerchantStaticItems)
{
...
void UMerchantComponent::AddItem_Implementation(int64 ItemID)
{
